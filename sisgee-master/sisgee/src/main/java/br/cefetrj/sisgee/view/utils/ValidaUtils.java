...
public class ValidaUtils {
	...
	public static String validaObrigatorioETamanho(String nomeCampo, int tamanho, String param) {
        ...
        /**
         * Método que valida a inserção de E-mails de campo opcional de acordo com seu formato
         * 
         * @param nomeCampo Texto com nome do campo de teste
         * @param param Valor do campo a ser testado
         * @return  String com mensagem de erro ou vazia em caso de sucesso
         */
