		...
		<h5><fmt:message key="br.cefetrj.sisgee.form_empresa.msg_titulo" /></h5>		
			...
			<fieldset class="form-group">
					...
					<label for="buscaNumero"><fmt:message key = "br.cefetrj.sisgee.resources.form.busca.numeroConvenio"/></label>
                                        <input type="search" placeholder="Insira o Numero do Convênio a Ser Encontrado Sem o Ano" class="form-control ${ not empty buscaNumeroMsg ? 'is-invalid': 'is-valid' }" id="buscaNumero" name="buscaNumero" maxlength="6" value="${ param.buscaNumero }">
					...
					<label for="buscaRazaoNome"><fmt:message key = "br.cefetrj.sisgee.resources.form.busca.razaoNome"/></label>
                                        <input type="search" placeholder="Insira o Nome ou Razão Social a Ser Encontrada" class="form-control  ${ not empty buscaRazaoNomeMsg ? 'is-invalid': 'is-valid' }" id="buscaRazaoNome" name="buscaRazaoNome" maxlength="100" value="${ param.buscaRazaoNome }">
