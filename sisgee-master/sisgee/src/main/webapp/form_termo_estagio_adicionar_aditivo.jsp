            ...
            <c:when test="${ not empty termo }">
                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 ${ not empty dataInicioMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataInicioTermoEstagio"  name="dataInicioTermoEstagio" value="${ not empty termo ? termo.dataInicioTermoEstagio.toString().replaceAll('-','') : '' }" disabled >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 ${ not empty dataFimMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataFimTermoEstagio"   name="dataFimTermoEstagio" value="${ not empty termo ? termo.dataFimTermoEstagio.toString().replaceAll('-','') : '' }" ${ vigencia.equals('sim') ? '' : 'disabled' } >
                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" maxlength="1" class="form-control col-sm-2 ${ not empty cargaHorariaMsg ? 'is-invalid': 'is-valid' }" id="cargaHorariaTermoEstagio" name="cargaHorariaTermoEstagio" value="${ not empty termo ? termo.cargaHorariaTermoEstagio : '' }" ${cargaHoraria.equals('sim') ? '' : 'readonly' }>
                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control col-sm-6 ${ not empty valorBolsaMsg ? 'is-invalid': 'is-valid' }" id="valorBolsa" name="valorBolsa" value="${not empty termo ? termo.valorBolsa : ''  }" ${valor.equals('sim') ? '' : 'readonly' }>
                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' } ${ empty termoEstagio ? '' : empty updEndereco ? 'disabled' : '' }>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" maxlength="255" class="form-control ${ not empty enderecoMsg ? 'is-invalid': not empty enderecoMsg ? 'is-invalid' : 'is-valid' }" id="enderecoTermoEstagio" name="enderecoTermoEstagio" value="${not empty termo ? termo.enderecoTermoEstagio : ''}" ${endereco.equals('sim') ? '' : 'readonly'}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" maxlength="10" class="form-control ${ not empty numeroEnderecoMsg ? 'is-invalid': not empty numeroEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="numeroEnderecoTermoEstagio" name="numeroEnderecoTermoEstagio" value="${not empty termo ? termo.numeroEnderecoTermoEstagio : '' }" ${endereco.equals('sim') ? '' : 'readonly'}>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input maxlength="150" type="text" class="form-control ${ not empty complementoEnderecoMsg ? 'is-invalid': not empty complementoEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="complementoEnderecoTermoEstagio" name="complementoEnderecoTermoEstagio" value="${not empty termo ? termo.complementoEnderecoTermoEstagio : '' }" ${endereco.equals('sim') ? '' : 'readonly'}>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" maxlength="150" class="form-control ${ not empty bairroEnderecoMsg ? 'is-invalid': not empty bairroEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="bairroEnderecoTermoEstagio" name="bairroEnderecoTermoEstagio" value="${ not empty termo ? termo.bairroEnderecoTermoEstagio : ''}" ${endereco.equals('sim') ? '' : 'readonly'}>
                    ...
                    <div class="form-row">					
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" maxlength="150" class="form-control ${ not empty cidadeEnderecoMsg ? 'is-invalid': not empty cidadeEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="cidadeEnderecoTermoEstagio" name="cidadeEnderecoTermoEstagio" value="${ not empty termo ? termo.cidadeEnderecoTermoEstagio : '' }" ${endereco.equals('sim') ? '' : 'readonly'}>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select name = "estadoEnderecoTermoEstagio" id="estadoEnderecoTermoEstagio" class="form-control ${ not empty estadoEnderecoMsg ? 'is-invalid': not empty estadoEnderecoMsg ? 'is-invalid' : 'is-valid' }" ${endereco.equals('sim') ? '' : 'readonly'}>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control ${ not empty cepEnderecoMsg ? 'is-invalid': not empty cepEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="cepEnderecoTermoEstagio" name="cepEnderecoTermoEstagio" value="${ not empty termo ? termo.cepEnderecoTermoEstagio : '' }" ${endereco.equals('sim') ? '' : 'readonly'}>
                ...
                <fieldset ${ isVisualizacao eq true ? 'disabled' :'' }>
                    <div class="form-group col-md-8">
                        ...
                        <select name="idProfessorOrientador" id="idProfessorOrientador" class="form-control ${ not empty idProfessorMsg ? 'is-invalid': not empty idProfessorMsg ? 'is-invalid' : 'is-valid' }"  ${endereco.equals('sim') ? '' : 'readonly'}>
                            <option value="" selected>---</option>
