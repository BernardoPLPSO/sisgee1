    ...
    <body>
        ...
        <form action="IncluirTermoAditivoServlet" method="post">
            <fieldset class="form-group" ${ not empty termoEstagio ? 'disabled' : '' }>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">						  
                            <input type="text" class="form-control numeroConvenio" placeholder="Digite o Número" id="numeroConvenio" name="numeroConvenio" value="${ not empty termoEstagio.convenioPJ ? termoEstagio.convenioPJ.numeroConvenio : termoEstagio.convenioPF.numeroConvenio }">
                ...
                <div class="form-row"  id="divPF" style="display:${not empty termoEstagio.convenioPF.nome ? '' : "none"}">
                    <div class="form-group col-md-5">
                        <label for="cpfConvenio"><fmt:message key = "br.cefetrj.sisgee.resources.form.cpf.pf"/></label>
                        <input type="text" class="form-control" id="cpfConvenio" name="cpfConvenio" value="${ termoEstagio.convenioPF.cpf }" readonly>
                    </div>
                    <div class="form-group col-md-5">
                        <label for="nomePF"><fmt:message key = "br.cefetrj.sisgee.resources.form.nomePessoaFisica"/></label>
                        <input type="text" class="form-control nomeEmpresaIsAI nomePF" id="nomePF" name="nomePF" value="${ termoEstagio.convenioPF.nome }" readonly>
                    </div>
                </div>
                <div class="form-row" id="divPJ" style="display:${not empty termoEstagio.convenioPJ ? '' : "none"}">
                    <div class="form-group col-md-5">
                        <label for="cnpjConvenio"><fmt:message key = "br.cefetrj.sisgee.resources.form.cnpj"/></label>
                        <input type="text" class="form-control nomeEmpresaIsAI nomePF" id="cnpjConvenio" name="cnpjConvenio" value="${ termoEstagio.convenioPJ.cnpj }" readonly>
                    </div>
                    <div class="form-group col-md-5">
                    ...
                    <div class="custom-controls-stacked d-block my-3" id="divAgt">
                        ...
                        <label class="custom-control custom-radio">
                            <input id="Agente" type="radio" class="custom-control-input isAgenteChk" name="agtInt" value="sim" ${termoEstagio.convenioPJ.agenteIntegracao ? 'checked' : '' }> 
                            <span class="custom-control-indicator"></span> 
                            <span class="custom-control-description" ><fmt:message key = "br.cefetrj.sisgee.resources.form.sim"/></span>
                        </label>						
                        <label class="custom-control custom-radio"> 
                            <input id="NaoAgente" type="radio" class="custom-control-input isAgenteChk" name="agtInt" value="nao" ${termoEstagio.convenioPJ.agenteIntegracao ? '' : 'checked'} > 
                            <span class="custom-control-indicator"></span> 
                            <span class="custom-control-description"><fmt:message key = "br.cefetrj.sisgee.resources.form.nao"/></span>
                        </label>
                    </div>
                    <c:if test="${termoEstagio.convenioPJ.agenteIntegracao}">
                        <div class="form-group col-md-4" id="divAgenciada" >
                            ...
                            <input name="agenciada" maxlength="150" id="agenciada" type="text" class="form-control" value="${termoEstagio.agenciada}" readonly> 
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" maxlength="100" class="form-control ${ not empty idAlunoMsg ? 'is-invalid': 'is-valid' }" id="matricula" name="matriculaPopUp" value="${ termoEstagio.aluno.matricula }" readonly>
                    ...
                    <div class="form-group col-md">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" value="${ termoEstagio.aluno.nomeAluno}" readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nomeCurso"><fmt:message key = "br.cefetrj.sisgee.resources.form.curso"/></label>
                        <input type="text" class="form-control" id="nomeCurso"  name="nomeCurso" value="${ termoEstagio.aluno.nomeCurso }" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="nomeCampus"><fmt:message key = "br.cefetrj.sisgee.resources.form.unidade"/></label>
                        <input type="text" class="form-control" id="nomeCampus"  name="nomeCampus" value="${ termoEstagio.aluno.nomeCampus }" readonly>
                    </div>
                </div>			
            ...
            <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control col-sm-4 ${ not empty dataFimMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataFimTermoEstagio"   name="dataFimTermoEstagio" value="${ not empty termoEstagio ? dataFim : '' }" ${ vigencia}  >
            ...
            <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" maxlength="1" class="form-control col-sm-2 ${ not empty cargaHorariaMsg ? 'is-invalid': 'is-valid' }" id="cargaHorariaTermoEstagio" name="cargaHorariaTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.cargaHorariaTermoEstagio : '' }" ${ cargaHoraria }>
            ...
            <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control col-sm-6 ${ not empty valorBolsaMsg ? 'is-invalid': 'is-valid' }" id="valorBolsa" name="valorBolsa" value="${valorBolsa}" ${valor}>
            ...
            <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' } ${ empty termoEstagio ? '' : empty updEndereco ? 'disabled' : '' }>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" maxlength="255" class="form-control ${ not empty enderecoMsg ? 'is-invalid': not empty enderecoMsg ? 'is-invalid' : 'is-valid' }" id="enderecoTermoEstagio" name="enderecoTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.enderecoTermoEstagio : ''}" ${endereco}>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input maxlength="150" type="text" class="form-control ${ not empty complementoEnderecoMsg ? 'is-invalid': not empty complementoEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="complementoEnderecoTermoEstagio" name="complementoEnderecoTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.complementoEnderecoTermoEstagio : '' }" ${ endereco}>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" maxlength="150" class="form-control ${ not empty bairroEnderecoMsg ? 'is-invalid': not empty bairroEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="bairroEnderecoTermoEstagio" name="bairroEnderecoTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.bairroEnderecoTermoEstagio : ''}" ${ endereco}>
                ...
                <div class="form-row">					
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" maxlength="150" class="form-control ${ not empty cidadeEnderecoMsg ? 'is-invalid': not empty cidadeEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="cidadeEnderecoTermoEstagio" name="cidadeEnderecoTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.cidadeEnderecoTermoEstagio : '' }" ${endereco }>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select name = "estadoEnderecoTermoEstagio" id="estadoEnderecoTermoEstagio" class="form-control ${ not empty estadoEnderecoMsg ? 'is-invalid': not empty estadoEnderecoMsg ? 'is-invalid' : 'is-valid' }" ${ endereco}>
                            ...
                            <c:if test="${ not empty termoEstagio }">
                                <option selected>${termoEstagio.estadoEnderecoTermoEstagio.toUpperCase()}</option>
                            </c:if>
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control ${ not empty cepEnderecoMsg ? 'is-invalid': not empty cepEnderecoMsg ? 'is-invalid' : 'is-valid' }" id="cepEnderecoTermoEstagio" name="cepEnderecoTermoEstagio" value="${ not empty termoEstagio ? termoEstagio.cepEnderecoTermoEstagio : '' }" ${ endereco}>
            ...
            <div class="form-row" >
                ...
                <div class="custom-controls-stacked d-block my-3" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    <label class="custom-control custom-radio"> 
                        <input id="estagioSim" name="eEstagioObrigatorio" type="radio" class="custom-control-input ${ not empty eEstagioObrigatorioMsg ? 'is-invalid' : '' }" value = "sim" ${ not empty termoEstagio ? 'disabled' :'' } ${ not empty termoEstagio ? termoEstagio.eEstagioObrigatorio == true ? 'checked' : '' : ''  }> 
                        <span class="custom-control-indicator"></span> 
                        <span class="custom-control-description" ><fmt:message key = "br.cefetrj.sisgee.resources.form.sim"/></span>
                    </label> 
                    <label class="custom-control custom-radio"> 
                        <input id="estagioNao" name="eEstagioObrigatorio" type="radio" class="custom-control-input ${ not empty eEstagioObrigatorioMsg ? 'is-invalid' : '' }" value = "nao" ${ not empty termoEstagio ? 'disabled' :'' } ${ not empty termoEstagio ?  termoEstagio.eEstagioObrigatorio == false ? 'checked' : '' : '' }> 
                        <span class="custom-control-indicator"></span> 
                        <span class="custom-control-description"><fmt:message key = "br.cefetrj.sisgee.resources.form.nao"/></span>
                    </label>
                </div>				
            ...
            <fieldset>
                <div class="form-group col-md-4">
                    ...
                    <input type="text" maxlength="150" class="form-control" name="nomeSupervisor" id="nomeSupervisor" value="${termoEstagio.nomeSupervisor}" readonly>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input name="cargoSupervisor" maxlength="150" id="cargoSupervisor" type="text" class="form-control" value ="${termoEstagio.cargoSupervisor}" readonly>
                ...
                <div class="form-group col-md-8">
                    ...
                    <select name="idProfessorOrientador" id="idProfessorOrientador" class="form-control ${ not empty idProfessorMsg ? 'is-invalid': not empty idProfessorMsg ? 'is-invalid' : 'is-valid' }" ${ empty termoEstagio ? '' : empty updProfessor ? 'disabled' : '' } ${professor}>
                        ...
                        <c:forEach items="${ professores }" var="professor">
                            <option ${termoEstagio.professorOrientador.idProfessorOrientador == professor.idProfessorOrientador ? 'selected' : ''} value="${ professor.idProfessorOrientador }">${ professor.nomeProfessorOrientador }</option>
                        </c:forEach>
