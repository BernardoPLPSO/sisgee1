                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 ${ not empty dataFimMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataFimTermoEstagio"   name="dataFimTermoEstagio" value="${ not empty termo ? termo.dataFimTermoEstagio.toString().replaceAll('-','') : '' }" ${ vigencia}  >
