                ...
                <fieldset class="form-group" ${ isVisualizacao eq true ? 'disabled' :'' }>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 ${ not empty dataInicioMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataInicioTermoEstagio"  name="dataInicioTermoEstagio" value="${ not empty termo ? dataIni : '' }" ${ not empty termo ? 'disabled' : '' } >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control col-sm-4 ${ not empty dataFimMsg ? 'is-invalid': not empty periodoMsg ? 'is-invalid' : 'is-valid' }" id="dataFimTermoEstagio"   name="dataFimTermoEstagio" value="${ not empty termo ? dataFim : '' }" ${ empty termo ? '' : empty updVigencia ? 'disabled' : '' } >
