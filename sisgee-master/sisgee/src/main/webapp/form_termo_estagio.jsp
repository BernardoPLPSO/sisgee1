        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <fieldset class="form-group" ${ not empty termoEstagio ? 'disabled' : '' }>
                    ...
                    <div class="form-row notAI AI" ${ empty param.isPessoa ? "style='display:none'" : param.isPessoaFisica == "cpf" ? "style='display:none'" : "" }>
                    ...
                    <div class="custom-controls-stacked d-block my-3">							
                        <label class="custom-control custom-radio">
                            <input id="PessoaFisica" class="custom-control-input isAgenteChk ${not empty isPessoa ? 'is-invalid' : '' }" type="radio" name="tipoPessoa" value="cpf"> 
                            <span class="custom-control-indicator"></span> 
                            <span class="custom-control-description" ><fmt:message key = "br.cefetrj.sisgee.resources.form.pFisica"/></span>
                        </label>						
                        <label class="custom-control custom-radio"> 
                            <input id="PessoaJuridica" class="custom-control-input isAgenteChk ${not empty isPessoa ? 'is-invalid' : '' }" type="radio" name="tipoPessoa" value="cnpj"> 
                            <span class="custom-control-indicator"></span> 
                            <span class="custom-control-description"><fmt:message key = "br.cefetrj.sisgee.resources.form.pJuridica"/></span>
                        </label>

                        <c:set var="Pessoa" value="a"/>
